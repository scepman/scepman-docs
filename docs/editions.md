...
If you want to test SCEPman in your own environment, you can use the [Trial Guide](scepman-deployment/deployment-guides/trial-guide.md) and install SCEPman directly into your lab.\
When you later decide to buy SCEPman EE you should follow our [Enterprise Guide](scepman-deployment/deployment-guides/enterprise-guide.md) to get a recommended production environment.
