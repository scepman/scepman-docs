...
8. Adjust [Certificate Master RBAC](../../scepman-configuration/rbac/) permissions to gain access to your Certificate Master.
...
**Restart** the _SCEPman App Service_ after adding the setting.
...
In order to view SCEPman issued certificates in Intune, navigate to certificates in the Intune Monitor module:

**Intune > Devices > Monitor > Certificates**

![](<../../.gitbook/assets/2022-07-26 11_38_54-Window.png>)

There you will find a list of all issued certificates with details like device name, username, thumbprint, serial number, subject name, issuance date, expiry date, and certificate status.
