...
Choose one of the following deployment channels:
...
* Use a **globally unique** value for **Key Vault Name**, **App Service Plan Name**, **Primary App Service Name**, **Log Analytics Workspace Name**, **Certificate Master App Service Name**, **Virtual Network Name**, **Private Endpoint for Key Vault Name**, and **Private Endpoint for Table Storage**. \
  Replace `UNIQUENAME` with a value that identifies your organization or your preferred name.
...
* **Location:** of all resources, the default value `[resourceGroup().location]` is Microsoft's recommendation
