...
The deployment of SCEPman 2.x is different from a SCEPman 1.x deployment. If you want to install a new SCEPman 2.x instance or upgrade your existing 1.x instance keep reading. If you want to install a new SCEPman 1.x instance, please follow the original guide [here](../deployment-guides/trial-guide.md).
...
After a successful deployment of SCEPman 2.x please follow the [Post-Installation Configuration](../permissions/post-installation-config.md) article.
...
This means you can just [switch between channels in the main component as was possible before](../../advanced-configuration/application-artifacts.md)
...
When it comes to the main SCEPman component, you can just switch between versions using the [WEBSITE\_RUN\_FROM\_PACKAGE](../../advanced-configuration/application-artifacts.md#change-artifacts) setting.
