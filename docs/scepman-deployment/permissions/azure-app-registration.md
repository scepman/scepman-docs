...
{% hint style="info" %}
Only the **1.x** versions require an Azure App Registration. SCEPman 2.x still supports it, but we recommend using the [SCEPman PowerShell Module](../../scepman-configuration/post-installation-config.md).
{% endhint %}
...
| [Back to Trial Guide](../deployment-guides/trial-guide.md#step-1-azure-app-registration) | [Back to Community Guide](../deployment-guides/community-guide.md#step-1-azure-app-registration) | [Back to Enterprise Guide](../deployment-guides/enterprise-guide.md#step-1-azure-app-registration) |
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
