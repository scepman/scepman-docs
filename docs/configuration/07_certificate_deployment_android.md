...
It is not only possible to deploy certificates on [Windows 10 devices](05_certificate_deployment_win10.md) or [macOS devices](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/06_certificate_deployment_macOS.md), of course you can create [Android](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/07_cert_mobile_client.md#android-enterprise-certificate-deployment) and [iOS](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/07_cert_mobile_client.md#ios-enterprise-certificate-deployment) profiles as well. All platforms are supported by SCEPman.
...
[![GetCACert](../.gitbook/assets/scepman24%20%281%29.png)](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/media/scepman24.png)

Then, create a profile in Microsoft Intune:

[![TrustedCertificate](../.gitbook/assets/scepman_android1.png)](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/media/scepman_android1.png)
...
[![SCEPServerURL](../.gitbook/assets/scepman27.png)](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/media/scepman27.png)
...
[![SCEPCertificate](../.gitbook/assets/scepman_android1_1.png)](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/media/scepman_android1_1.png)
...
>
> [![TrustedCertificateMandatory](../.gitbook/assets/scepman_android2.png)](https://github.com/glueckkanja/gk-scepman-docs/tree/8dd5e83c3dd91576810d6a7f58bb173cb6cc9536/docs/media/scepman_android2.png)
